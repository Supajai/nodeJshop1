/* public/js/utils.js (หรือ config.js ที่คุณใช้อยู่) */
const API_URL = 'http://localhost:3000/api';
const money = (num) => '฿' + Number(num).toLocaleString();

// ✅ แก้ไข: รับ parameter 'isMultipart'
function getHeaders(isMultipart = false) {
    ...
    // ถ้าไม่ใช่การส่งไฟล์ (isMultipart = false) ให้ใช้ JSON เหมือนเดิม
    if (!isMultipart) {
...
// ✅ ระบบแจ้งเตือนใหม่: Popup สวยๆ กลางจอ
...
// Wrapper สำหรับเรียกใช้แทน showToast เดิม
